...
--
-- Data for Name: countries; Type: TABLE DATA; Schema: public; Owner: chriskl
--
...
--
-- Data for Name: countrylanguages; Type: TABLE DATA; Schema: public; Owner: chriskl
--

COPY countrylanguages (countrycode, "language", isofficial, percentage) FROM stdin;
...
ALTER TABLE ONLY countrylanguages
    ADD CONSTRAINT countrylanguages_pkey PRIMARY KEY (countrycode, "language");
