...
SELECT name, percentage, code FROM countrylanguages JOIN countries ON countrylanguages.countrycode = countries.code WHERE language = 'Italian' AND isofficial = 't' AND percentage = 100;
...
SELECT countrycode, name FROM cities WHERE name LIKE 'Serra%'  
...
-- She's in ___Santa Monica__USA_________________!
